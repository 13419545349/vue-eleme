...
const cartcontrol = (resolve)=>{import('../cartcontrol/cartcontrol.vue')
                   .then((cartcontrol)=>{resolve(cartcontrol)})};

const split = (resolve)=>{import('../split/split.vue')
                    .then((split)=>{resolve(split)})};

const ratingselect = (resolve)=>{import('../ratingselect/ratingselect.vue')
                   .then((ratingselect)=>{resolve(ratingselect)})};
	...
	.food{
        ...
        .content{
        	...
        	.price{
        		font-weight:700;
        		line-height:24px;
        		.now{margin-right:8px;font-size:14px;
        			color:rgb(240,20,20)}
        		.old{
